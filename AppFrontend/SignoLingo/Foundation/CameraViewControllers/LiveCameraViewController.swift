...
final class LiveCameraViewController: UIViewController {
    ...
    /// Set running to false to pause the camera
    ...
    nonisolated private func run(_ running: Bool) async {
        // Viewcontrollers are @MainActor by default.
        // This function is nonisolated async which means
        // it does not run on the ViewController's actor.
        // This avoids hanging the main thread when calling
        // startRunning takes a long time
        if running {
